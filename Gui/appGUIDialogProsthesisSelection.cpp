...
void appGUIDialogProsthesisSelection::CreateDialog()
{
	if (m_Gui == NULL)
	{
		...
		if (m_CurrentProducer)
		{
			...
			m_ProducerName_Link = new appGUIHyperLink(this, NULL, m_ProducerWebSite);
...
//----------------------------------------------------------------------------
void appGUIDialogProsthesisSelection::SetProducer(albaString producerName)
{
	std::vector<albaProDBProducer *> DBproducers = m_DBManager->GetProducers();
...
//----------------------------------------------------------------------------
void appGUIDialogProsthesisSelection::SetProducer(albaProDBProducer *producer)
{
	if (producer)
	{
		wxString DBDir = m_DBManager->GetDBDir();
...
//----------------------------------------------------------------------------
void appGUIDialogProsthesisSelection::SetProsthesis(albaProDBProsthesis *prosthesis)
{
