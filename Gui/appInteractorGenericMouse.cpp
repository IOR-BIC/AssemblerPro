...
albaCxxTypeMacro(appInteractorGenericMouse);

// ----------------------------------------------------------------------------
appInteractorGenericMouse::appInteractorGenericMouse() 
{ }
...
//----------------------------------------------------------------------------
void appInteractorGenericMouse::TrackballRotate()
{
	// mouse position
...
//----------------------------------------------------------------------------
void appInteractorGenericMouse::TrackballRoll()
{
