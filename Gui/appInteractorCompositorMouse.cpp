...
albaCxxTypeMacro(appInteractorCompositorMouse);

//----------------------------------------------------------------------------
albaInteractorGenericMouse *appInteractorCompositorMouse::CreateBehavior(MMI_ACTIVATOR activator)
{
  // create the generic behavior and populate the map
  appInteractorGenericMouse *pISAG = appInteractorGenericMouse::New();
...
//------------------------------------------------------------------------------
void appInteractorCompositorMouse::OnEvent(albaEventBase *event)
{  
	assert(event);
...
//------------------------------------------------------------------------------
void appInteractorCompositorMouse::InitInteraction(int buttonPressed, albaEventInteraction *e)
{
	double pos[2];
	e->Get2DPosition(pos);
...
//----------------------------------------------------------------------------
void appInteractorCompositorMouse::OnButtonDown(albaEventInteraction *e)
{
...
//----------------------------------------------------------------------------
void appInteractorCompositorMouse::OnButtonUp(albaEventInteraction *e)
{
	m_ButtonPressed = e->GetButton();
