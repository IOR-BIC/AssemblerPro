...
//----------------------------------------------------------------------------
appGUITransformMouse::appGUITransformMouse(albaVME *input, albaObserver *listener): albaGUITransformMouse(input, listener)
{
	UpdateISA();
}
//----------------------------------------------------------------------------
appGUITransformMouse::~appGUITransformMouse() 
{ 
}

//----------------------------------------------------------------------------
void appGUITransformMouse::UpdateISA()
{
	...
	m_IsaCompositor = appInteractorCompositorMouse::New();
...
//----------------------------------------------------------------------------
bool appGUITransformMouse::IsSliceView(albaView *v)
{
...
//----------------------------------------------------------------------------
void appGUITransformMouse::OnEvent(albaEventBase *alba_event)
{
...
//----------------------------------------------------------------------------
appInteractorGenericMouse* appGUITransformMouse::CreateBehavior(MMI_ACTIVATOR activator)
{
	return (appInteractorGenericMouse*)m_IsaCompositor->CreateBehavior(activator);
}